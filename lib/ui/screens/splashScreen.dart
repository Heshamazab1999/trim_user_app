          ...
          listener: (final BuildContext context,
            ...
            if (state is SystemSettingFetchSuccess) {
              ...
              final String? latestAndroidVersion =
                  generalSettings.customerCurrentVersionAndroidApp;
              final latestIOSVersion =
                  generalSettings.customerCurrentVersionIosApp;
              ...
              if ((Platform.isAndroid &&
                ...
                if (generalSettings.customerCompulsaryUpdateForceUpdate ==
                    '1') {
                  await Navigator.pushReplacementNamed(
                    context,
                    appUpdateScreen,
