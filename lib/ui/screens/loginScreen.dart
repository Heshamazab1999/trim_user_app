...
class _LogInScreenState extends State<LogInScreen> {
  ...
  _onContinueButtonClicked() async {
    ...
    // HiveRepository.setUserToken = user.credential!.accessToken;
  ...
  Widget _buildContinueButton() =>
      BlocConsumer<VerifyPhoneNumberCubit, VerifyPhoneNumberState>(
        ...
        if (verifyPhoneNumberState is SendVerificationCodeInProgress) {
          ...
          errorMessage =
              findFirebaseError(context, verifyPhoneNumberState.error.code);
          UiUtils.showMessage(context, errorMessage.translate(context: context),
              MessageType.error);
        }
      }, builder: (final BuildContext context,
              final VerifyPhoneNumberState verifyPhoneNumberState) {
        Widget? child;
