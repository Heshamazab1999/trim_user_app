...
extension AppColors on ColorScheme {
  ...
  static Color lightAccentColor = const Color(0xff2C73AB);
  static Color lightSubHeadingColor1 = const Color(0xff343F53);

  static Color darkPrimaryColor = const Color(0xff060606);
  static Color darkSecondaryColor = const Color(0xff2A2C3E);
  static Color darkAccentColor = const Color(0xff2C73AB);
